        ...
        style={{ backgroundImage: `url(${background1})`}}>
            ...
            <div className="flex flex-col gap-3 w-72 md:w-88">
                ...
                <div className="flex justify-between mb-2">
                    ...
                    className={`flex-1 py-2 ${mode === "login" ? "bg-blue-700 text-white" : "bg-gray-300"}`}
                    >
                    Login
                    </button>
                    ...
                    className={`flex-1 py-2 ${mode === "register" ? "bg-blue-700 text-white" : "bg-gray-300"}`}
                    >
                    Register
                    </button>
                </div>
                ...
                {mode === "register" && (
                    <>
                        ...
                        <button onClick={handleRegister} className="bg-green-600 text-white py-2 rounded mt-2">Register</button>
                    </>
                )}
                ...
                {mode === "login" && (
                    <>
                        ...
                        <button onClick={handleLogin} className="bg-blue-700 text-white py-2 rounded">Login</button>
                    </>
                )}
