    ...
    return (
        <div className="w-full min-h-screen bg-gray-200 flex justify-center">
            ...
            <div className="w-full max-w-[450px] min-h-screen overflow-hidden relative">
                ...
                <div className="absolute z-99 w-full h-50 mt-20 opacity-70" style={{ backgroundImage: `url(${background1})`, backgroundRepeat: `no-repeat`, backgroundPosition: `center`, backgroundSize: "cover"}}></div>

                <div className="relative w-full h-screen overflow-hidden flex flex-col bg-gradient-to-b from-black via-[#3a1f1f] to-[#FF6B6B] pt-2 md:pt-16">
                    ...
                    <section className="relative shrink-0 flex flex-col items-center text-center pt-10 sm:pt-2 gap-1">
                        ...
                        <div className="mb-10 md:-mt-6">
                            <h2 className="text-white text-sm md:text-md tracking-widest">PIECES SPORT</h2>
                            <h1 className="text-white text-3xl font-bold leading-tight">PLAY & WIN</h1>
                        </div>               
                    ...
                    {/* GRID SECTION */}
                    <div className="flex-1 overflow-hidden px-3 py-3 grid grid-cols-2 gap-2 auto-rows-fr">

                        {/* Play & Win */}
                        <div onClick={playandwinBtn} className="relative row-span-2 rounded-xl shadow-lg overflow-hidden cursor-pointer
                        hover:scale-[1.03] transition bg-[linear-gradient(to_bottom,#997A00_0%,#eab308_12%,#000000_12%,#6b7280_88%,#997A00_88%,#eab308_100%)]">
                            
                            <div className="relative z-10 flex flex-col items-center justify-center h-full sm:gap-2 -mt-5 sm:-mt-0 pb-2 sm:pb-4 text-white">
                                <h3 className="text-lg md:text-xl font-bold text-center sm:-mb-6">Play & WIN</h3>
                                <div className="flex items-center justify-center gap-2">
                                    <img src={vsleft} alt="left" className="w-[14vw] max-w-[100px] min-w-[80px] sm:max-w-[70px]  h-auto object-contain" />
                                    <span className="text-xl font-bold">VS</span>
                                    <img src={vsright} alt="right" className="w-[14vw] max-w-[100px] min-w-[80px] sm:max-w-[70px] h-auto object-contain" />
                                </div>
                            </div>
                            <div className="absolute bottom-0 left-0 right-0 z-20 flex flex-col items-center mb-2 ">
                                <p className="text-sm md:text-md font-semibold text-white drop-shadow md:-mb-2">Prediction CHALLENGE</p>
                        ...
                        {/* Soccer Quiz */}
                        <div onClick={quizBtn} className="group relative rounded-xl p-[1px] overflow-hidden cursor-pointer transition duration-300 hover:scale-105">
                            ...
                            <div className="relative rounded-xl px-2 bg-white/10 backdrop-blur-xl border border-white/20 shadow-xl overflow-hidden h-full">
                                ...
                                <div className="relative flex items-center justify-between h-full z-10">
                                    ...
                                    <div>
                                        <h3 className="font-bold uppercase text-black/90 tracking-wide text-md">Soccer Quiz</h3>
                        ...
                        <div className="group relative rounded-xl p-[1px] overflow-hidden cursor-pointer transition duration-300 hover:scale-105">
                            ...
                            <div className="relative rounded-xl px-2 bg-white/10 backdrop-blur-xl border border-white/20 shadow-xl overflow-hidden h-full">
                                ...
                                <div className="relative flex items-center justify-between h-full z-10">
                                    ...
                                    <div>
                                        <h3 className="font-bold uppercase text-black/90 tracking-wide text-md">Live Score</h3>
                        ...
                        <div className="group relative rounded-xl p-[1px] overflow-hidden cursor-pointer transition duration-300 hover:scale-105">
                            ...
                            <div className="relative rounded-xl px-2 bg-[#EB1B4C]/10 backdrop-blur-xl border border-[#EB1B4C]/20 shadow-xl overflow-hidden h-full">
                                ...
                                <div className="relative flex items-center justify-between h-full z-10">
                                    ...
                                    <div>
                                        <h3 className="font-bold uppercase text-white text-md tracking-wide">Infotainment</h3>
                        ...
                        <div className="group relative rounded-xl p-[1px] overflow-hidden cursor-pointer transition duration-300 hover:scale-105">
                            ...
                            <div className="relative rounded-xl px-2 bg-[#8D2EED]/10 backdrop-blur-xl border border-[#8D2EED]/20 shadow-xl overflow-hidden h-full">
                                ...
                                <div className="relative flex items-center justify-between h-full z-10">
                                    ...
                                    <div>
                                        <h3 className="font-bold uppercase text-white text-lg tracking-wide">Free Game</h3>
                        ...
                        flex items-center justify-center gap-3 md:gap-6 cursor-pointer hover:scale-[1.02] transition">
                            ...
                            <h3 className="font-bold uppercase text-xl">Profile</h3>
                        ...
                        <div className="group relative rounded-xl p-[1px] overflow-hidden cursor-pointer transition duration-300 hover:scale-105">
                            ...
                            <div className="relative rounded-xl px-2 bg-[#244184]/10 backdrop-blur-xl border border-[#244184]/20 shadow-xl overflow-hidden h-full">
                                ...
                                <div className="relative flex items-center justify-between h-full z-10">
                                    ...
                                    <div>
                                        <h3 className="font-bold uppercase text-white text-lg tracking-wide">Buy Coins</h3>
                        ...
                        {/* Settings */}
                        <div className="group bg-gray-300/70 backdrop-blur-md border border-white/40 rounded-xl px-2 shadow-lg col-span-2
                            flex items-center justify-center gap-3 md:gap-6 cursor-pointer hover:scale-105 transition">
                            
                            <Settings className="md:w-8 md:h-8 text-black/80 transition-transform duration-300 group-hover:rotate-180" />
                            <h3 className="font-bold uppercase text-xl">Setting</h3>
                    ...
                    {/* FOOTER */}
                    <div className="shrink-0 bg-black w-full py-1 text-center font-bold border-t-2 border-blue-600">
